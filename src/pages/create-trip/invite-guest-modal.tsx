...
interface InviteGuestModalProps{
    closeInviteGuestModalOpen: () => void
}

export function InviteGuestModal({
    closeInviteGuestModalOpen, 
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              <div className='flex items-center justify-between'>
                ...
                <button type='button' onClick={closeInviteGuestModalOpen}>
                  <X className="size-5 text-zinc-400" />
                </button>
              </div>
              <p className='text-sm text-zinc-400'>
                O convidado irá receber e-mail para confirmar a presença da viagem.
              </p>
            </div>
